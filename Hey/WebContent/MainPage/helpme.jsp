...
<body>
	<input type="button" value="홈화면" id="home"> 
	<jsp:include page="logoutprocess.jsp" />
	...
	<form action="helpmewrite.mvc">
		...
		<table>
			...
			<tr>
				<th>조건</th>
				<td colspan=2><input type="radio" name="gender" value="무관"
					checked>무관 <input type="radio" name="gender" value="여자">여자
					<input type="radio" name="gender" value="남자">남자 <br> <select
					name="sido" id="sido"></select> <select name="gugun" id="gugun"></select>
			</tr>
			<tr>
				<th>내용</th>
